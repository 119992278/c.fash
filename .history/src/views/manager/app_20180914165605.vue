<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="当前版本" width="210" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
          <el-tag>ios: {{ scope.row.appVersionIos }}</el-tag>
          <el-tag>andriod: {{ scope.row.appVersionIos }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column label="IOS版本" width="210" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
          <el-tag>{{ scope.row.appVersionIos }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column label="andriod版本" width="210" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
          <el-tag>{{ scope.row.appVersionAndroid }}</el-tag>
        </template>
      </el-table-column>
