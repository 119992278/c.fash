<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="IOS更新操作" min-width="160" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
      ...
      <el-table-column label="andriod更新操作" min-width="160" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
