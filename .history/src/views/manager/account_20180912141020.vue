...
import { getAccountList, addDealer, editDealer, getDealerInfo, getListCustomer } from '@/api/dealer'
  ...
  methods: {
    ...
    handleDialog: function(params) {
      ...
      getListCustomer({}).then(response => {
        response.rows.find(function(value1, index, arr) {
          console.log({ value: value1.customerCode, label: value1.customerName })
