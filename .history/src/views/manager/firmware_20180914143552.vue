  ...
  <div class="app-container">
    ...
    <el-dialog :title="dialogStatus" :visible.sync="dialogHardwareFormVisible" center modal show-close top="3vh" width="70%">
      <el-form ref="dataForm" :model="temp" :rules="rules" >
        ...
        <el-table :data="gridData" fit>
          <el-table-column property="versionId" label="版本号" width="110"/>
          <el-table-column property="firmwareType" label="Name" width="110"/>
          <el-table-column property="deviceVersion" label="deviceVersion" width="110"/>
          <el-table-column property="buildVersion" label="buildVersion" width="110"/>
          <el-table-column property="updateUrl" label="updateUrl" width="400" show-overflow-tooltip/>
          <el-table-column property="md5" label="md5" width="400" show-overflow-tooltip/>
