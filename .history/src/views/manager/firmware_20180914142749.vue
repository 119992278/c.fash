    ...
    <el-dialog :title="dialogStatus" :visible.sync="dialogHardwareFormVisible" center modal show-close top="3vh" width="60%">
      <el-form ref="dataForm" :model="temp" :rules="rules">
        ...
        <el-table :data="gridData">
          <el-table-column property="versionId" label="版本号" width="150"/>
          <el-table-column property="firmwareType" label="Name" width="200"/>
          <el-table-column property="firmwareType" label="Name" width="200"/>
          <el-table-column property="deviceVersion" label="deviceVersion"/>
          <el-table-column property="buildVersion" label="buildVersion"/>
          <el-table-column property="updateUrl" label="updateUrl"/>
