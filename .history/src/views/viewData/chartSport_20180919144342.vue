...
export default {
  ...
  methods: {
    ...
    changplace(val) {
      console.log(JSON.stringify(dayjs(val[0]).startOf('day').format('YYYY-MM-DD HH:mm:ss')))
      console.log(JSON.stringify(dayjs(val[1]).endOf('day').format('YYYY-MM-DD HH:mm:ss')))
    }
  }
}
</script>
