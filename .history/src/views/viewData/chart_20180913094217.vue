  ...
  methods: {
    fetchData() {
      ...
      getCountRegUser(this.listQuery).then(response => {
        const _tempYdata = [709, 1917, 2455, 2610, 1719, 1433, 1544, 3285, 2455, 2610, 1719, 1433, 1544, 3285, 5208, 3372, 2455, 2610, 1719, 1433, 1544, 3285, 5208, 3372, 2484, 4078]
        response.rows.map(function(value, key, arr) {
          // _tempYdata[value.unitFormat] = parseInt(value.number)
        })
