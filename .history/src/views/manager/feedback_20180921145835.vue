<template>
  <div class="app-container">
    <el-table
      ...
      <el-table-column label="答案" min-width="80" align="left" show-overflow-tooltip>
        <template v-if="scope.row.edit" slot-scope="scope">
          <template >
            <el-input class="edit-input" size="small"/>
            <el-button v-if="scope.row.edit" type="success" size="small" icon="el-icon-circle-check-outline" @click="confirmEdit(scope.row)">Ok</el-button>
            <el-button v-if="scope.row.edit" type="success" size="small" icon="el-icon-circle-check-outline" @click="confirmEdit(scope.row)">cancel</el-button>
          </template>
        </template>
      </el-table-column>
