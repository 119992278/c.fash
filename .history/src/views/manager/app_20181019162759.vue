<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column :label="$t('table.updateTime')" width="180px" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
          {{ scope.row.insertTimeIos }}
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.appName')" min-width="130" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.operation')" min-width="160" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
