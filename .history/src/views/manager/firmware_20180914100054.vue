      ...
      <el-form ref="form" :model="form" :rules="rules">
        <el-form-item :label-width="formLabelWidth" label="上传固件:" prop="customerAccount">
          <el-upload
            ...
            <div slot="tip" class="el-upload__tip">只能上传zip文件，且不超过800kb</div>
          </el-upload>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="名字:" prop="customerAddress">
          <el-input v-model="form.customerAddress"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="编号:" prop="customerAddress">
          <el-input v-model="form.customerAddress"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="版本号:" prop="customerAddress">
          <el-input v-model="form.customerContact"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="升级地址:" prop="customerAddress">
          <el-input v-model="form.customerCode"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="CRC:" prop="customerAddress">
          <el-input v-model="form.customerName"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="更新说明:" prop="customerAddress">
          <el-input v-model="form.customerEamil"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="固件功能:" prop="customerAddress">
