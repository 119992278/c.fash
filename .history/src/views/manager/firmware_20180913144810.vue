  ...
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="操作" min-width="180" align="center">
        <template slot-scope="scope">
          <el-button :disabled="!$store.state.user.authority.authority1.includes(String(scope.row.customerId))" size="mini" type="success" @click="handleUpdate(scope.row)">发布更新</el-button>
