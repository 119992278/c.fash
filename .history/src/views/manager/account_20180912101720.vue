  ...
  <div class="app-container">
    ...
    <el-dialog :title="dialogStatus" :visible.sync="dialogFormVisible" center modal show-close top="1vh" width="70%">
      <el-form ref="dataForm" :model="temp" :rules="rules">
        ...
        <el-form-item :label-width="formLabelWidth" label="超级管理员:">
        ...
        <el-form-item :label-width="formLabelWidth" label="查看数据:">
          <el-checkbox-group v-model="temp.authoList">
        ...
        <el-form-item :label-width="formLabelWidth" label="推广服务:">
          <el-checkbox-group v-model="temp.authoList">
        ...
        <el-form-item :label-width="formLabelWidth" label="设置:">
          <el-checkbox-group v-model="temp.authoList">
...
import { getAccountList, addDealer } from '@/api/dealer'
...
export default {
  ...
  methods: {
    ...
    createData: function() {
      alert(JSON.stringify(this.form.authoList))
      this.form.authotity = this.form.authoList.join(',')
      // delete this.form.authoList
