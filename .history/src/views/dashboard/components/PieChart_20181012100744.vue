...
export default {
  ...
  data() {
    return {
      xdata: [i18n.t('chart.former60'), '60后', '70后', '80后', '90后', '00后'],
      ydata: [{ 'value': 0, 'name': '60后' }, { 'value': 0, 'name': '70后' }, { 'value': 0, 'name': '80后' }, { 'value': 0, 'name': '90后' }, { 'value': 0, 'name': i18n.t('chart.former60') }, { 'value': 0, 'name': '00后' }],
      chart: null
    }
  },
  created() {
