<template>
  <div class="app-container">
    ...
    <el-dialog :visible.sync="dialogFormAuthority" title="授权管理" center modal show-close top="1vh" width="55%">
      <el-form-item v-if="temp.customerType=='2'" :label-width="formLabelWidth" :"label="公司编号">
        <el-checkbox-group v-model="checkedCities" @change="handleCheckedCitiesChange">
          <el-checkbox v-for="city in customeroptions" :label="city.value" :key="city.val">{{ city.label }}</el-checkbox>
        </el-checkbox-group>
      </el-form-item>
    </el-dialog>
    <el-dialog :title="dialogStatus" :visible.sync="dialogFormVisible" center modal show-close top="1vh" width="55%">
...
import { getAccountList, addDealer, editDealer, getDealerInfo, getListCustomer, queryAccountAuthority } from '@/api/dealer'
