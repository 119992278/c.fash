  ...
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="操作" min-width="180" align="center">
        <template slot-scope="scope">
          <el-button :disabled="scope.row.currentVersion === scope.row.newVersion" size="medium" type="success" @click="handleOpen(scope.row)">发布更新</el-button>
          <el-button size="medium" type="primary" @click="handleUpdate(scope.row)">编辑</el-button>
        </template>
      </el-table-column>
    </el-table>
