...
export default {
  ...
  created() {
    this.initChart(['60前', '60后', '70后', '80后', '90后', '00后'], [{ 'value': 1408, 'name': '60后' }, { 'value': 2841, 'name': '70后' }, { 'value': 6788, 'name': '80后' }, { 'value': 8933, 'name': '90后' }, { 'value': 4764, 'name': '60前' }, { 'value': 5367, 'name': '00后' }])
  },
  mounted() {
    setTimeout(() => {
      this.fetchData()
