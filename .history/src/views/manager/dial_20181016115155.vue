  ...
  <div class="app-container">
    ...
    <el-dialog :title="dialogStatus" :visible.sync="dialogFormVisible" center modal show-close top="3vh" width="40%">
      <el-form ref="dataForm" :model="temp" :rules="rules">
        <el-form-item :label-width="formLabelWidth" :label="$t('table.watchFaceUrl')">
          <el-upload
            :auto-upload="false"
    ...
    <el-table
      ...
      <el-table-column :label="$t('table.watchFaceUrl')" min-width="110" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.operation')" min-width="180" align="center">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="danger" icon="el-icon-close" @click="handleDelete(scope.row)">{{ $t('table.delete') }}</el-button>
        </template>
      </el-table-column>
    </el-table>
