  ...
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column :label="$t('table.operation')" min-width="280" align="center">
        <template slot-scope="scope">
          <el-button :disabled="scope.row.currentVersion === scope.row.newVersion" size="small" type="success" @click="handleOpen(scope.row)">{{ $t('table.hardwareRelease') }}更新</el-button>
