<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column :label="$t('table.hadwareCode')" width="110" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
          <span class="link-type" @click="handleHardwareForm(scope.row)">{{ scope.row.productCode }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.currentHardwareVersion')" min-width="160" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.updateDescriprion')" min-width="160" align="left" show-overflow-tooltip>
        <template slot-scope="scope">
