...
export const constantRouterMap = [
...

  {
    ...
    children: [
      ...
      },
      {
        path: 'chart',
        name: '用户图表',
        component: () => import('@/views/viewData/chartDay'),
  ...
  },
  {
    ...
    children: [
      {
        path: 'chart',
        component: () => import('@/views/viewData/index'), // Parent router-view
        name: '用户注册数',
        meta: { title: '用户注册数' },
        children: [
          {
            ...
            component: () => import('@/views/viewData/chartDay'),
            name: '每天注册',
            meta: { title: '每天注册', icon: '' }
          },
          {
            path: 'chartWeek',
            component: () => import('@/views/viewData/chartWeek'),
            name: '每季度注册',
            meta: { title: '每季度注册' }
          },
          {
            path: 'chartYear',
            component: () => import('@/views/viewData/chartYear'),
            name: '每年注册',
            meta: { title: '每年注册' }
          }
        ]
      },
      {
        ...
        component: () => import('@/views/viewData/index'), // Parent router-view
        name: '用户设备数',
        meta: { title: '用户设备数', icon: '' },
        children: [
          {
            path: 'chartDay',
            component: () => import('@/views/viewData/chartDay'),
            name: '每天激活数',
            meta: { title: '每天激活数', icon: '' }
          },
          {
            path: 'chartWeek',
            component: () => import('@/views/viewData/chartWeek'),
