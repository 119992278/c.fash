    ...
    <el-tabs v-model="activeName" type="border-card" @tab-click="handleTabClick">
      ...
      <el-tab-pane label="已回复" name="call">
        <el-table
          ...
          <el-table-column label="操作" width="100" align="center">
            <template slot-scope="scope">
              <el-button v-if="scope.row.feedBackAnswer === null" size="mini" type="success" @click="updateData">答复</el-button>
              <el-button v-else size="mini" type="success" disabled>已答复</el-button>
            </template>
          </el-table-column>
        </el-table>
      ...
      <el-tab-pane label="未回复" name="nocall">
        <el-table
          ...
          <el-table-column label="操作" width="100" align="center">
            <template slot-scope="scope">
              <el-button v-if="scope.row.feedBackAnswer === null" size="mini" type="success" @click="handleUpdate">答复</el-button>
              <el-button v-else size="mini" type="success" disabled>已答复</el-button>
            </template>
          </el-table-column>
        </el-table>
...
export default {
  ...
  methods: {
    ...
    handleUpdate: function(row) {
      ...
      // addfeedBack(row.watchFaceId).then(response => {
      //   this.dialogFormVisible = true
