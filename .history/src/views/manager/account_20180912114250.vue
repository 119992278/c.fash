  ...
  <div class="app-container">
    ...
    <el-dialog :title="dialogStatus" :visible.sync="dialogFormVisible" center modal show-close top="1vh" width="70%">
      <el-form ref="dataForm" :model="temp" :rules="rules">
        ...
        <el-form-item :label-width="formLabelWidth" label="公司地址:" prop="customerPassword">
          <el-input v-model="temp.customerAddress"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="联系方式:" prop="customerPassword">
          <el-input v-model="temp.customerContact"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="公司编码:" prop="customerPassword">
          <el-input v-model="temp.customerCode"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="公司名称:" prop="customerPassword">
          <el-input v-model="temp.customerName"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="邮箱:" prop="customerPassword">
          <el-input v-model="temp.customerEamil"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="联系人:" prop="customerPassword">
          <el-input v-model="temp.contactUser"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="账户类型:" prop="customerPassword">
