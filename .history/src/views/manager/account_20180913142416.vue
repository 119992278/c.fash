  ...
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="操作" min-width="180" align="left">
        <template slot-scope="scope">
          <el-button :disabled="!userAuthority1.includes(String(scope.row.customerId))" size="mini" type="success" @click="handleUpdate(scope.row)">编辑</el-button>
...
export default {
  ...
  created() {
    this.fetchData()
    console.log(this.userAuthority1)
  },
  mounted() {
  },
  methods: {
