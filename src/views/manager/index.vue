<template>
  <div class="app-container">
    <el-button class="filter-item" type="primary" icon="el-icon-edit" @click="search('coach')">新增</el-button>
    <el-input v-model="searchVal" style="width: 200px;" class="filter-item" placeholder="search"/>
    ...
    <el-table
      ...
      <el-table-column label="账号" min-width="130" align="center">
        <template slot-scope="scope">
    ...
    <el-pagination :current-page="listQuery.sEcho" :page-sizes="[10,20,30,40,50]" :page-size="listQuery.limit" :total="totalQuantity" background layout="total, sizes, prev, pager, next, jumper" @size-change="handleSizeChange" @current-change="handleCurrentChange"/>
  </div>
</template>
