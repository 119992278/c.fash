    ...
    <el-dialog :title="dialogStatus" :visible.sync="dialogFormVisible" center modal show-close top="3vh" width="70%">
      <el-form ref="dataForm" :model="temp" :rules="rules">
        ...
        <el-form-item :label-width="formLabelWidth" label="编号:" prop="productCode">
          <el-input v-model="temp.productCode"/> <el-tag>(命名规则:项目英文_事业部编号_客户英文简称 例 WT10_OEM02_appscomm)</el-tag>
        </el-form-item>
        ...
        <div class="dialog-footer" align="right">
          <el-button v-if="dialogStatus=='新增固件'" type="primary" @click="createData">新增</el-button>
...
import { getProductList, addProduct, getHardwareVersion, getproductInfo } from '@/api/dealer'
