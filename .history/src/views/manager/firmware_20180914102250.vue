      ...
      <el-form ref="form" :model="form" :rules="rules">
        <el-form-item :label-width="formLabelWidth" label="上传固件:" prop="customerAccount">
          <el-upload
            ...
            <!-- <el-button style="margin-left: 10px;" size="small" type="success" @click="submitUpload">上传到服务器</el-button> (只能上传zip文件，且不超过800kb) -->
          </el-upload>
        </el-form-item>
        ...
        <el-form-item :label-width="formLabelWidth" label="升级地址:" >
          <el-input v-model="form.updateUrl" disabled/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="CRC:" prop="fileCrcSize">
...
export default {
  ...
  methods: {
    ...
    handleSuccess(file) {
      this.form.updateUrl = file.msg
      console.log(this.form.updateUrl)
    }
  }
}
</script>
