...
// 编辑固件版本信息
export async function editProductVersionInfo(params) {
  const result = await request({
    url: '/dealer/product/version/save',
    method: 'post',
    data: params
  })
  return await addHistory('固件版本编辑【' + params.productName + '】', result)
}
...
export async function addApp(params) {
  ...
  return await addHistory('新增app【' + params.appChineseName + '】', result)
}
...
export async function updateApp(params) {
  ...
  return await addHistory('更新app【' + params.appChineseName + '】', result)
}
...
// 编辑表盘信息
export async function editWatchFace(params) {
  const result = await request({
    url: '/dealer/watchFace/update',
    method: 'post',
    data: params
  })
  return await addHistory('编辑表盘【' + params.watchFaceName + '】', result)
}
...
// 新增表盘信息
export async function addWatchFace(params) {
  const result = await request({
    url: '/dealer/watchFace/add',
    method: 'post',
    data: params
  })
  return await addHistory('新增表盘【' + params.watchFaceName + '】', result)
}
