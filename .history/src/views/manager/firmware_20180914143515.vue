    ...
    <el-dialog :title="dialogStatus" :visible.sync="dialogHardwareFormVisible" center modal show-close top="3vh" width="70%">
      <el-form ref="dataForm" :model="temp" :rules="rules" >
        ...
        <el-table :data="gridData" fit>
          <el-table-column property="versionId" label="版本号" width="120"/>
          <el-table-column property="firmwareType" label="Name" width="120"/>
          <el-table-column property="firmwareType" label="Name" width="120"/>
          <el-table-column property="deviceVersion" label="deviceVersion" width="120"/>
          <el-table-column property="buildVersion" label="buildVersion" width="120"/>
