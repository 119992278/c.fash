<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="IOS当前版本" width="210" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
          {{ scope.row.appVersionIos }}
        </template>
      </el-table-column>
      <el-table-column label="andriod当前版本" width="210" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
