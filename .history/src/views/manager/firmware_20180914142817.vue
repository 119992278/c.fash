<template>
  <div class="app-container">
    ...
    <el-dialog :title="dialogStatus" :visible.sync="dialogHardwareFormVisible" center modal show-close top="3vh" width="60%">
      <el-form ref="dataForm" :model="temp" :rules="rules">
        ...
        <el-table :data="gridData">
          <el-table-column property="versionId" label="版本号" width="30"/>
          <el-table-column property="firmwareType" label="Name" width="30"/>
          <el-table-column property="firmwareType" label="Name" width="30"/>
          <el-table-column property="deviceVersion" label="deviceVersion"/>
          <el-table-column property="buildVersion" label="buildVersion"/>
          <el-table-column property="updateUrl" label="updateUrl" width="200"/>
          <el-table-column property="md5" label="md5" width="200"/>
    ...
    <el-table
      ...
      <el-table-column label="固件功能" min-width="160" align="let" show-overflow-tooltip>
        <template slot-scope="scope">
      ...
      <el-table-column label="操作" min-width="180" align="center">
        <template slot-scope="scope">
          <el-button :disabled="scope.row.currentVersion === scope.row.newVersion" size="mini" type="success" @click="handleOpen(scope.row)">发布更新</el-button>
