...
export default {
  ...
  data() {
    return {
      xdata: [i18n.t('chart.former60'), i18n.t('chart.background60'), i18n.t('chart.background70'), '80后', '90后', '00后'],
      ydata: [{ 'value': 0, 'name': i18n.t('chart.background60') }, { 'value': 0, 'name': i18n.t('chart.background70') }, { 'value': 0, 'name': '80后' }, { 'value': 0, 'name': '90后' }, { 'value': 0, 'name': i18n.t('chart.former60') }, { 'value': 0, 'name': '00后' }],
      chart: null
    }
  },
  created() {
