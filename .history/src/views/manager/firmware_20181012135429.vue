<template>
  <div class="app-container">
    ...
    <el-dialog :title="dialogStatus" :visible.sync="dialogHardwareFormVisible" center modal show-close top="3vh" width="70%">
      <el-form ref="dataForm" :model="temp" :rules="rules" >
        ...
        <el-table :data="gridData">
          ...
          <el-table-column label="deviceVer" align="center" min-width="110" show-overflow-tooltip>
            <template slot-scope="scope">
              <el-input v-model="scope.row.deviceVersion"/>
            </template>
          </el-table-column>
          <el-table-column label="buildVer" align="center" min-width="110" show-overflow-tooltip>
            <template slot-scope="scope">
    ...
    <el-table
      ...
      <el-table-column :label="$t('table.hadwareCode')" min-width="110" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
