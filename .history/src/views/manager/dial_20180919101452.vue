  ...
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="操作" min-width="180" align="center">
        <template slot-scope="scope">
          <el-button :disabled="scope.row.currentVersion !== scope.row.newVersion" size="mini" type="success" @click="handleUpdate(scope.row)">编辑</el-button>
          <el-button size="mini" type="danger" icon="el-icon-edit" @click="handleUpdate(scope.row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
import { getWatchFacelist, addProduct, getHardwareVersion, getproductInfo, editProductInfo } from '@/api/dealer'
