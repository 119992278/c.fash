    ...
    <el-dialog :title="authorityName" :visible.sync="dialogFormAuthority" center modal show-close top="1vh" width="70%">
      <el-form ref="dataForm" :model="temp" :rules="rules">
        <el-form-item :label-width="formLabelWidth" label="公司编号:">
          <el-checkbox-group v-model="authority1" size="medium" @change="handleCheckedCitiesChange('authority1')">
        ...
        <el-form-item :label-width="formLabelWidth" label="授权APP:">
          <el-checkbox-group v-model="authority2" size="medium" @change="handleCheckedCitiesChange('authority2')">
        ...
        <el-form-item :label-width="formLabelWidth" label="授权固件:">
          <el-checkbox-group v-model="authority3" size="medium" @change="handleCheckedCitiesChange('authority3')">
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      getListCustomer({}).then(response => {
        response.rows.map(function(value1, index, arr) {
          _this.customerList.push({ value: String(value1.customerId), label: value1.customerCode })
        })
      })
    },
    search(name) {
    ...
    handleCheckedCitiesChange: function(obj, val) {
