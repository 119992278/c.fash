  ...
  <div class="app-container">
    ...
    <el-dialog :title="dialogStatus" :visible.sync="dialogFormVisible" center modal show-close top="1vh" width="70%">
      <el-form ref="dataForm" :model="temp" :rules="rules">
        <el-form-item :label-width="formLabelWidth" label="账号:" prop="noEmpty">
          <el-input v-model="temp.customerAccount"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="密码:" prop="noEmpty" >
          <el-input v-model="temp.customerPassword" type="password"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="公司中文名称:" prop="noEmpty">
          <el-input v-model="temp.customerName"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="公司编码:" prop="noEmpty">
          <el-input v-model="temp.customerCode"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="联系人:" prop="noEmpty">
          <el-input v-model="temp.contactUser"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="公司地址:" prop="noEmpty">
          <el-input v-model="temp.customerAddress"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="联系方式:" prop="noEmpty">
          <el-input v-model="temp.customerContact"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="邮箱:" prop="noEmpty">
          <el-input v-model="temp.customerEamil"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="账户类型:" prop="noEmpty">
...
import { getAccountList, addDealer, editDealer, getDealerInfo } from '@/api/dealer'
    ...
    handleUpdate: function(row) {
      getDealerInfo(row.customerAccountId).then(response => {
        ...
        this.temp = {
          ...
          customerPassword: response.data.customerPassword,
          customerToken: response.data.customerToken,
          customerType: String(response.data.customerType),
          customerEamil: response.data.email,
          sex: String(response.data.sex),
          customerCode: response.data.customerCode,
          customerAddress: response.data.address,
          contactUser: response.data.contactUser,
          authoList: response.data.authotity.split(',')
        }
      })
    },
    createData: function() {
