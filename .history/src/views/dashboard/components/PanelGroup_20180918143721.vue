  ...
  <el-row :gutter="40" class="panel-group">
    ...
    <el-col class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('purchases')">
        ...
        <div class="card-panel-description">
          <div class="card-panel-text">总激活设备数</div>
          <count-to :start-val="0" :end-val="totalDevice" :duration="3200" class="card-panel-num"/>
        </div>
      </div>
    </el-col>
    <el-col class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('shoppings')">
        ...
        <div class="card-panel-description">
          <div class="card-panel-text">今日激活设备数</div>
...
import { getRegUserCount, getDeviceCount } from '@/api/dealer'
export default {
  components: {
    CountTo
  },
  ...
  methods: {
    ...
    getDeviceCount() {
      getDeviceCount({ beforeDays: null }).then(response => {
        this.totalUser = response.data
      })
      getRegUserCount({ beforeDays: 0 }).then(response => {
        this.todayUser = response.data
