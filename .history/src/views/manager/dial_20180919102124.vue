...
import { getWatchFacelist, addProduct, getHardwareVersion, getwatchFaceById, editProductInfo } from '@/api/dealer'
...
export default {
  ...
  methods: {
    ...
    handleUpdate: function(row) {
      ...
      getwatchFaceById(row.getwatchFaceById).then(response => {
        this.dialogFormVisible = true
