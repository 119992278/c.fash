...
export default {
  ...
  data() {
    return {
      content: '<table align="center"><tbody><tr class="firstRow"><td style="font-weight: bold; word-break: break-all;">亲爱的： {{userName}}&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</td></tr><tr><td>欢迎您注册我们的运动手环。您的账号已注册完成，请使用以下账号进行App的登陆：</td></tr><tr><td>邮箱:</td></tr><tr><td>{{userMail}}</td></tr><tr><td><br/></td></tr><tr><td><br/></td></tr><tr><td>-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</td></tr><tr><td style="word-break: break-all;">本邮件由系统自动发送，请勿回复<br/><br/></td></tr></tbody></table><p><br/></p>',
      editorOption: {
        modules: {
          toolbar: [
