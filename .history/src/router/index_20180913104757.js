...
export const constantRouterMap = [
...

  {
    ...
    children: [
      ...
      },
      {
        path: 'chart',
        name: '用户图表',
        component: () => import('@/views/userData/chartDay'),
  ...
  },
  {
    ...
    children: [
      {
        path: 'chart',
        component: () => import('@/views/userData/index'), // Parent router-view
        name: '用户注册数',
        meta: { title: '用户注册数' },
        children: [
          {
          ...
          {
            path: 'chartWeek',
            component: () => import('@/views/userData/chartWeek'),
            name: '每季度注册',
            meta: { title: '每季度注册' }
          },
          {
            path: 'chartYear',
            component: () => import('@/views/userData/chartYear'),
            name: '每年注册',
            meta: { title: '每年注册' }
          }
        ]
