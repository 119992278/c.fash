  ...
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="操作" min-width="160" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
          <el-button size="small" type="success" @click="handleModifyStatus(scope.row)">IOS</el-button>
          <el-button size="small" type="success" @click="handleModifyStatus(scope.row)">Android</el-button>
        </template>
      </el-table-column>
