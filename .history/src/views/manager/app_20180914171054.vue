  ...
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="发布新版本" min-width="180" align="center">
        <template slot-scope="scope">
          <el-button v-if="scope.row.status!='published'" size="mini" type="success" @click="handleOpen(scope.row)">IOS</el-button>
          <el-button v-if="scope.row.status!='draft'" size="mini" type="primary" @click="handleOpen(scope.row)">Android</el-button>
        </template>
      </el-table-column>
    </el-table>
