<template>
  <div class="app-container">
    <el-table
      ...
      <el-table-column label="公司名称" width="140" align="center">
        <template slot-scope="scope">
          {{ scope.row.customerName }}
        </template>
      </el-table-column>
      <el-table-column label="公司编号" width="140" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="操作" width="120" align="center">
        <template slot-scope="scope">
          ...
          <el-button type="primary" icon="el-icon-edit" size="small">授权</el-button>
        </template>
      </el-table-column>
    </el-table>
  </div>
