<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="邮件标识" width="110" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
...
import { getTemplateList, addProduct, getHardwareVersion, getproductInfo, editProductInfo } from '@/api/dealer'
