<template>
  <div class="app-container">
    ...
    <el-input v-model="searchVal" style="width: 200px;" class="filter-item" placeholder="请输入需要查询"/>
    ...
    <el-table
      ...
      <el-table-column label="固件名称" min-width="130" align="let" show-overflow-tooltip>
        <template slot-scope="scope">
      ...
      <el-table-column label="当前固件版本" min-width="130" align="let" show-overflow-tooltip>
        <template slot-scope="scope">
