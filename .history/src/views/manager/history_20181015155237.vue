<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column :label="$t('table.userAccount')" min-width="180" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
          {{ scope.row.accountId }}
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.operationTime')" min-width="180" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
          <span>{{ scope.row.operationTime | momentStamp }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.operationText')" min-width="180" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
...
<script>
import { momentStampFormat, cleanCustomerId, tableRowClassName } from '@/utils/index'
