  ...
  <div class="app-container">
    ...
    <el-dialog :title="dialogStatus" :visible.sync="dialogFormVisible" center modal show-close top="1vh" width="70%">
      <el-form ref="dataForm" :model="temp" :rules="rules">
        ...
        <el-form-item :label-width="formLabelWidth" label="公司编码:" prop="customerCode">
          <el-input v-model="temp.customerCode" disabled="dialogStatus == '编辑账户'"/>
        </el-form-item>
        ...
        <el-form-item :label-width="formLabelWidth" label="账户类型:">
          <el-radio-group disabled="dialogStatus == '编辑账户' v-model="temp-customer-type->
