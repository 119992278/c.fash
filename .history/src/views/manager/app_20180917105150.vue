...
import { getAPPList, addProduct, addApp, getListCustomer, getProductList, getWatchFaceList, getVersionById, addAppVersion, getAPPById } from '@/api/dealer'
  ...
  methods: {
    ...
    handleUpdate: function(row) {
      ...
      getAPPById(row.appId).then(response => {
        ...
        this.productList = this.temp.productId.split(',')
        this.productList.map(function(value1, index, arr) {
          this.productList[index] = String(value1)
        })
      })
    },
