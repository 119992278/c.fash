<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <!-- <el-table-column :label="$t('table.status')" min-width="100" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
          {{ scope.row.status | statusStamp2 }}
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.updateTime')" min-width="160" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
          {{ scope.row.updateTime | momentStamp }}
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.updateUser')" min-width="160" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
          {{ scope.row.operator }}
        </template>
      </el-table-column> -->
...
export default {
  ...
  methods: {
    ...
    handleCheckedCitiesChange: function(val) {
      const _this = this
      this.appList.map(function(value1, index) {
