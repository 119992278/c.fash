  ...
  methods: {
    ...
    addDialogHardwareForm() {
      this.gridData.push({
        ...
        'deviceVersion': '2',
        'buildVersion': '3',
        'updateUrl': 'https://testnew.appscomm.cn/download/workspace(方舟蓝牙小程序).zip',
        'updateMessage': null,
        'fileCrcSize': null,
        'invalidStatus': null,
        ...
        'byforce': 1,
        'firmwareType': '1',
        'md5': 'D053679D869B61E1E725C9273F1A06F7'
      })
    },
    updateData: function() {
      this.$refs['dataForm'].validate((valid) => {
    ...
    uploadhandleOnSuccess(file) {
      const _temp = { updateUrl: process.env.BASE_API + file.msg }
      this.gridData[2].updateUrl =
