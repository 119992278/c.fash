<template>
  <div class="dashboard-editor-container">
    ...
    <LineChart :xdata="xdata" :chart-data="lineChartData"/>
    <el-row :gutter="32">
...
import { getCountRegUserCountRegUser, getCountBindUser } from '@/api/dealer'
export default {
  name: 'DashboardAdmin',
  components: {
    PanelGroup,
  ...
  methods: {
    fetchData() {
      getCountRegUserCountRegUser(this.listQuery).then(response => {
        const _tempYdata = []
