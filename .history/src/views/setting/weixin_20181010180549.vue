...
export default {
  ...
  methods: {
    handleClose(tag) {
      this.const bodyParser = require('koa-bodyparser').splice(this.const bodyParser = require('koa-bodyparser').indexOf(tag), 1)
    },
    ...
    handleInputConfirm() {
      ...
      if (inputValue) {
        this.const bodyParser = require('koa-bodyparser').push(inputValue)
      }
