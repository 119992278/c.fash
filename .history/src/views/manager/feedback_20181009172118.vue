  ...
  <div class="app-container">
    <el-dialog :title="dialogStatus" :visible.sync="dialogFormVisible" center modal show-close top="3vh" width="40%">
      <el-form ref="dataForm" :model="listQuery">
        <el-form-item :label-width="formLabelWidth" label="问题:" prop="">
          <el-input v-model="temp.opiNion" disabled/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="回复:" prop="">
...
export default {
  ...
  methods: {
    ...
    handleUpdate: function(row) {
      ...
      this.temp.opiNion = row.opiNion
      this.temp.opinionId = row.opinionId
