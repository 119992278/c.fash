...
export async function addAccount(params) {
  ...
  return await addHistory(result, '新增账户【' + params.contactUser + '】')
}
// 编辑账户
...
export async function editProductInfo(params) {
  ...
  return await addHistory(result, '固件编辑' + params.productName + '】')
}

// 编辑固件信息
export async function editProductInfo1(params) {
  return request({
    url: '/dealer/product/edit',
    method: 'post',
    data: params
...
// 添加操作历史
export function addHistory(result, operate) {
