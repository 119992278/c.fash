<template>
  <div class="app-container">
    ...
    <el-dialog :title="dialogStatus" :visible.sync="dialogUrlVisible" center modal show-close top="3vh" width="80%">
    ...
    <el-table
      ...
      <el-table-column label="操作" min-width="160" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
          ...
          <el-button size="small" type="success" @click="handleOpen(scope.row)">Android</el-button>
        </template>
      </el-table-column>
