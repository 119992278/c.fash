...
import { getTemplateList, addTemplate, getHardwareVersion, getproductInfo, editProductInfo } from '@/api/dealer'
  ...
  data() {
    return {
      ...
      temp: {
        ...
        status: '1',
        subject: '主题',
        template: '模板内容123412341412421<img src=http: //testc.appscomm.cn/template/img/1537166792090013176.png" title="1537166792090013176.png" alt="logo.png"/><audio controls="controls" style="display: none;"></audio>',
        templateType: '111'
      },
      listQuery: {
