  ...
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="操作" min-width="160" align="center" show-overflow-tooltip>
        <template slot-scope="scope">
          <el-button size="medium " type="success" @click="handleModifyStatus(scope.row,'published')">IOS</el-button>
          <el-button size="medium " type="success" @click="handleModifyStatus(scope.row,'published')">Android</el-button>
        </template>
      </el-table-column>
      <el-table-column label="发布新版本" min-width="180" align="center">
        <template slot-scope="scope">
          <el-button size="medium " type="success" @click="handleOpen(scope.row)">IOS</el-button>
          <el-button size="medium " type="primary" @click="handleOpen(scope.row)">Android</el-button>
        </template>
      </el-table-column>
    </el-table>
